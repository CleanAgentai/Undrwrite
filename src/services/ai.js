...
- FORBIDDEN INTERNAL ROUTING REFERENCES (in your email to the broker): never name "Franco", never reference "the lender rep", "our team", "the underwriters", "internal review", any "passing along" phrasing ("passing it along", "passing this along", "passing everything along", "passing the file along", "passing along to..."), "forwarding to", "I'll get this over to", or any specific internal department or person. The broker should know only that the file has been received and is being reviewed.
...
- The broker is sourcing a deal, NOT granting approval. NEVER write "thanks for confirming approval", "thanks for confirming the approval", "you've approved", or any phrase that implies the broker is approving anything.
- FORBIDDEN APPROVAL PHRASES (do not write any of these in your email): "approved", "approval", "passed review", "looks good", "everything is in order", "thanks for confirming the approval", "for final assessment", "going to underwriting", "final approval and terms", "for final review by our team".
- FORBIDDEN INTERNAL ROUTING REFERENCES (in your email to the broker): never name "Franco", never reference "the lender rep", "our team", "the underwriters", "internal review", any "passing along" phrasing ("passing it along", "passing this along", "passing everything along", "passing the file along", "passing along to..."), "forwarding to", "I'll get this over to", or any specific internal department or person. The broker should know only that the file is being reviewed.
...
- FORBIDDEN INTERNAL ROUTING REFERENCES (in the revised email): never name "Franco" to the broker, never reference "the lender rep", "our team", "the underwriters", "internal review", any "passing along" phrasing ("passing it along", "passing this along", "passing everything along", "passing the file along", "passing along to..."), "forwarding to", "I'll get this over to", or any specific internal department or person.
...
- FORBIDDEN APPROVAL PHRASES (do not write any of these in your email): "approved", "approval", "passed review", "looks good", "everything is in order", "thanks for confirming the approval", "for final assessment", "going to underwriting", "final approval and terms", "for final review by our team".
- FORBIDDEN INTERNAL ROUTING REFERENCES (in your email to the broker): never name "Franco" to the broker, never reference "the lender rep", "our team", "the underwriters", "internal review", any "passing along" phrasing ("passing it along", "passing this along", "passing everything along", "passing the file along", "passing along to..."), "forwarding to", "I'll get this over to", or any specific internal department or person. The broker should know only that the file has been received and is being reviewed. Even though Franco's notes drove this reply, do NOT attribute it to him by name.
