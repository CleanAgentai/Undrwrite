...
(async () => {
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName}. Credit score 720 per most recent pull (Q1 2026). Property ${property.full}, $280k.\n\nExit strategy: borrower intends to sell the property at end of term.\n\n${broker.signoff}`,
  ...
  const correction = buildPostmarkPayload({
    ...
    textBody: `Refreshed credit score: 695 (we pulled fresh today; small drop from a recent late payment that's already cured). Doesn't affect underwriting band materially — still A-tier.\n\n${broker.signoff}`,
