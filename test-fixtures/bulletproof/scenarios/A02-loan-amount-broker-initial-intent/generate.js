...
(async () => {
  ...
  fs.writeFileSync(path.join(DOCS_DIR, 'loan_application.pdf'), await synthLoanApp({
    ...
    propertyValue: 850000, loanAmount: 410000,
    transactionType: 'Refinance', mortgagePosition: '1st mortgage',
    existingFirstMortgageBalance: 320000, existingFirstMortgageLender: lender.name,
  }));
  fs.writeFileSync(path.join(DOCS_DIR, 'mortgage_statement.pdf'), await synthMortgageStatement({
    ...
    balance: 320000, payoffAmount: 321500, interestRate: 5.05, validityDate: '2026-06-25',
  }));
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName}. Loan amount requested: $410,000. Property ${property.full}, appraised $850k.\n\nExit strategy: borrower intends to sell the property at end of term.\n\n${broker.signoff}`,
