...
(async () => {
  ...
  // Intake intentionally omits NOA — Vienna should ask for it, then go to silence
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName}. Sending what I have now — NOA still pending CRA upload, will follow up once it arrives.\n\nProperty: ${property.full}\nLoan amount: $460,000\n\nExit strategy: borrower intends to sell the property at end of term.\n\n${broker.signoff}`,
  ...
  console.log(`[${SCENARIO_ID}] Generated 3 docs + 1-event sequence (silent path — replay drives chase-cron forward)`);
