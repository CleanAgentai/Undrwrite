...
(async () => {
  ...
  fs.writeFileSync(path.join(DOCS_DIR, 'loan_application.pdf'), await synthLoanApp({
    ...
    propertyAddress: property.full, propertyValue: 850000, loanAmount: 525000,
...
Clean refinance submission for ${borrower.fullName}.

Property: ${property.full}
Property value (appraised): $850,000
Existing first mortgage: ${lender.name}, balance $410,000
Loan amount requested: $525,000
