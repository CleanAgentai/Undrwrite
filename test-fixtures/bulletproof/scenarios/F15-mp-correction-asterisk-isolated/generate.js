...
(async () => {
  ...
  fs.writeFileSync(path.join(DOCS_DIR, 'loan_application.pdf'), await synthLoanApp({
    ...
    propertyValue: 850000, loanAmount: 95000,
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName} at ${property.full}, $95k.\n\n${broker.signoff}`,
  ...
  const correction = buildPostmarkPayload({
    ...
    textBody: `Position update — this is a 2nd mortgage*, keeping ${lender.name} first in place.\n\n${broker.signoff}`,
