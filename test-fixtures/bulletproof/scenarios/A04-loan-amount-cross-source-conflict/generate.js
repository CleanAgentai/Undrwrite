...
(async () => {
  ...
  // loan_app $245k; derived-from-LTV ~$390k (60% × $650k); broker correction $320k
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName}. Target LTV roughly 60% on $650k property — exact loan amount to be confirmed.\n\n${broker.signoff}`,
  ...
  const correction = buildPostmarkPayload({
    ...
    textBody: `Confirmed loan amount: $320,000. Ignore the $245k on the loan application form — that was from an earlier draft. The 60% LTV target was a ceiling; borrower's final ask is $320k.\n\n${broker.signoff}`,
