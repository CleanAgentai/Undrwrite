...
(async () => {
  ...
  // Loan_app says $220k; mortgage_statement says $225k (different)
  fs.writeFileSync(path.join(DOCS_DIR, 'loan_application.pdf'), await synthLoanApp({
    ...
    existingFirstMortgageBalance: 220000, existingFirstMortgageLender: lender.name,
  }));
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName}. Existing first mortgage ${lender.name} — see payout statement for current balance.\n\n${broker.signoff}`,
