...
(async () => {
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName}, $360k requested.\n\n${broker.signoff}`,
  ...
  const correction = buildPostmarkPayload({
    ...
    textBody: `Quick update — borrower confirmed exit strategy: refinance into single first at maturity, expected 18 months. Adding context per Franco's earlier note.\n\n${broker.signoff}`,
