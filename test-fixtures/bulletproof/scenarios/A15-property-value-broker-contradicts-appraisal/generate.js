...
(async () => {
  ...
  // Loan_app + appraisal show $720k; broker email asserts $850k
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName}. Property ${property.full}, market value $850,000 (recent comps; appraisal attached came in conservative at $720k but the area is heating up). Loan amount $460,000.\n\nExit strategy: borrower intends to sell the property at end of term.\n\n${broker.signoff}`,
