...
(async () => {
  ...
  const street = '287 Glencairn Avenue, Toronto, ON';
  const loanAppAddr = `${street} M5N 1V3`;
  const apprAddr = `${street} M5N 1V4`;
