...
(async () => {
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nFirst mortgage refinance for ${borrower.fullName}. ${property.full}. Loan amount $525,000; existing first mortgage ${lender.name} balance $410,000.\n\n${broker.signoff}`,
