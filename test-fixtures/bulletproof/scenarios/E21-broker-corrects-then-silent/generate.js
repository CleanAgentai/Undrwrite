...
(async () => {
  ...
  const intake = buildPostmarkPayload({
    ...
    textBody: `Hi Franco,\n\nRefi for ${borrower.fullName}, $460k.\n\n${broker.signoff}`,
  ...
  const correction = buildPostmarkPayload({
    ...
    textBody: `Possibly bumping the loan amount — borrower considering additional consolidation. Will confirm later this week.\n\n${broker.signoff}`,
  ...
  console.log(`[${SCENARIO_ID}] Generated 3 docs + 2-event sequence (broker silent after correction)`);
